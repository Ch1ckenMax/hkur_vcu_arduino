...
DriveManager driveManager(DRIVE_MODE_PIN, REVERSE_MODE_PIN, THROTTLE_PIN_A, THROTTLE_PIN_B, THROTTLE_MIN_A, THROTTLE_MIN_B, THROTTLE_MAX_A, THROTTLE_MAX_B, MAX_TORQUE, FILTER_FREQ, MAW_SIZE);
